...
function MostOrdered() {
    ...
    const [foodItems, setFoodItems] = useState([
        { id: 1, name: "Spicy seasoned seafood noodles", price: 2.29, imageSrc: "../src/assets/food1.png", quantity: 200, totalPrice: 0, OrderNote: "" },
        { id: 2, name: "Salted Pasta with mushroom sauce", price: 2.69, imageSrc: "../src/assets/food2.png", quantity: 120, totalPrice: 0, OrderNote: "" },
        { id: 3, name: "Beef Dumpling in hot and sour soup", price: 2.99, imageSrc: "../src/assets/food3.png", quantity: 80, totalPrice: 0, OrderNote: "" },
    ]);
                        ...
                        <div className="conf-pic-and-name-and-price">
                            <div className="conf-pic-and-name-and-price-2">
                                ...
                                <div className="name-and-price">
                                    ...
                                    <p className="name-and-price-p-p">{foodItem.quantity} dishes ordered</p>
                                </div>
                            </div>
