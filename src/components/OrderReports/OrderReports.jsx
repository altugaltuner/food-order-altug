...
const OrderReports = () => {
    ...
    const orders = [
        // ...sipariş verileriniz burada olmalı...
        {
            ...
            menu: "Spicy seasoned seafood noodles with maccaroni sauce ",
            totalPayment: 125,
            status: "Completed",
        },
        {
            ...
            menu: "Salted Pasta with mushroom sauce and garlic toast",
            totalPayment: 145,
            status: "Preparing",
        },
        {
            ...
            menu: "Beef dumpling in hot and sour soup and soy sauce",
            totalPayment: 105,
            status: "Pending",
        },
        {
            ...
            menu: "Hot spicy fried rice with omelet and french fries",
            totalPayment: 45,
            status: "Completed",
        },
        {
            ...
            menu: "Sichuan hot pot mixed seafood and vegetables",
            totalPayment: 245,
            status: "Completed",
        },
    ];
