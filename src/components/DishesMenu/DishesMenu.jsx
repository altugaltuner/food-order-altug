...
function DishesMenu() {
    ...
    const dishes = [
        ...
        { id: 4, name: "Healthy noodle with spinach leaf", price: 3.20, imageSrc: photo2, coldDish: false, soup: true },
        ...
        { id: 8, name: "Rosemary Citrus Roasted Chicken", price: 4.80, imageSrc: photo1, coldDish: true, soup: false },
        { id: 9, name: "Smoky Barbecue Beef Brisket", price: 4.10, imageSrc: photo1, coldDish: true, soup: true },
